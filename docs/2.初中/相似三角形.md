...
$$
\frac1{EF}=\frac1{AB}+\frac1{CD}.
$$

同一结构也可转化为面积关系：

$$
\frac1{S_{\triangle BCF}}
=
\frac1{S_{\triangle ABC}}
+
\frac1{S_{\triangle BCD}}.
$$
...
$$
\angle CDF=180^\circ-\angle C-\angle EDF,
$$

以及 $\angle BDE=\angle EDF$，可得

$$
\angle BED=\angle CDF.
$$

因此 $\triangle BED\sim\triangle CDF$，对应边成比例即得结论。
